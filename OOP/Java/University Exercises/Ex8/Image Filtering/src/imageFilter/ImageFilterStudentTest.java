...
public class ImageFilterStudentTest {
	...
	static float[][] edgeKernel = { { -1, -1, -1 }, { -1, 8, -1 }, { -1, -1, -1 } };
	...
	public void testLinearFilterNormal() {
		...
		assertEquals(4, cat_edge.getPixel(10,10), 0f);
	}
	...
	public void testLinearFilterPicture() throws IOException {
		...
		Image cat_edge_solution = new Image("cat_edge.pgm");
		Image cat_edge = filter.linearFilter(cat, edgeKernel);
		assertArrayEquals(cat_edge.getData(),cat_edge_solution.getData());
	}
